...
#
# Changes: data_requirement_ids on helpdesk_ticket was a Many2many stored in
#          junction table rel_ticket_2_data_requirement.
...
_OLD_JUNCTION_TABLE = "rel_ticket_2_data_requirement"
_RES_MODEL = "helpdesk_ticket"
...
def _migrate_junction_table(cr):
    ...
    openupgrade.logged_query(
        ...
        SELECT %s, ticket_id, data_requirement_id
